...
// Encode implements json.Marshaler.
func (s *UserTokenGetOK) Encode(e *jx.Encoder) {
	e.ObjStart()
	s.encodeFields(e)
	e.ObjEnd()
}
...
// encodeFields encodes fields.
func (s *UserTokenGetOK) encodeFields(e *jx.Encoder) {
}

var jsonFieldsNameOfUserTokenGetOK = [0]string{}

// Decode decodes UserTokenGetOK from json.
func (s *UserTokenGetOK) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode UserTokenGetOK to nil")
	}
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		return errors.Wrap(err, "decode UserTokenGetOK")
	}
...
// MarshalJSON implements stdjson.Marshaler.
func (s *UserTokenGetOK) MarshalJSON() ([]byte, error) {
	e := jx.Encoder{}
	s.Encode(&e)
	return e.Bytes(), nil
}
...
// UnmarshalJSON implements stdjson.Unmarshaler.
func (s *UserTokenGetOK) UnmarshalJSON(data []byte) error {
	d := jx.DecodeBytes(data)
	return s.Decode(d)
}

// Encode implements json.Marshaler.
func (s *UserTokenRefreshOK) Encode(e *jx.Encoder) {
	e.ObjStart()
	s.encodeFields(e)
	e.ObjEnd()
}
...
// encodeFields encodes fields.
func (s *UserTokenRefreshOK) encodeFields(e *jx.Encoder) {
}

var jsonFieldsNameOfUserTokenRefreshOK = [0]string{}

// Decode decodes UserTokenRefreshOK from json.
func (s *UserTokenRefreshOK) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode UserTokenRefreshOK to nil")
	}
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		return errors.Wrap(err, "decode UserTokenRefreshOK")
	}
...
// MarshalJSON implements stdjson.Marshaler.
func (s *UserTokenRefreshOK) MarshalJSON() ([]byte, error) {
	e := jx.Encoder{}
	s.Encode(&e)
	return e.Bytes(), nil
}
...
// UnmarshalJSON implements stdjson.Unmarshaler.
func (s *UserTokenRefreshOK) UnmarshalJSON(data []byte) error {
	d := jx.DecodeBytes(data)
	return s.Decode(d)
}
